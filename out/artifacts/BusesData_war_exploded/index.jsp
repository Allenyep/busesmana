...
<head>
  ...
  <!-- DATE RANGE PICKER -->
  <link rel="stylesheet" type="text/css" href="BusesIndex/js/bootstrap-daterangepicker/daterangepicker-bs3.css" />
  <!-- UNIFORM -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-md-offset-4">
          <div id="logo">
            <a href="#"><img src="BusesIndex/img/logo/logo-alt.png" height="40" alt="logo name" /></a>
          </div>
        </div>
      </div>
    </div>
...
<!-- JQUERY -->
<script src="BusesIndex/js/jquery/jquery-2.0.3.min.js"></script>
<!-- JQUERY UI-->
<script src="BusesIndex/js/jquery-ui-1.10.3.custom/js/jquery-ui-1.10.3.custom.min.js"></script>
<!-- BOOTSTRAP -->
<script src="BusesIndex/bootstrap-dist/js/bootstrap.min.js"></script>


<!-- UNIFORM -->
<script type="text/javascript" src="BusesIndex/js/uniform/jquery.uniform.min.js"></script>
<!-- CUSTOM SCRIPT -->
<script src="BusesIndex/js/script.js"></script>
<script>
